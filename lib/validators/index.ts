...
export const packageValues = ["FREE", "LITE", "STANDARD", "PRO", "CORPORATE", "MULTI_OFFICE", "ENTERPRISE"] as const;
export const paidPackageValues = ["LITE", "STANDARD", "PRO", "CORPORATE", "MULTI_OFFICE", "ENTERPRISE"] as const;
export const currentPackageValues = packageValues;
...
export const licenseRequestSchema = z.object({
  ...
  requestedPackage: z.enum(paidPackageValues),
