...
export function DashboardPreview({
  ...
  return (
    <div className="rounded-lg border border-[var(--line)] bg-[var(--panel)] p-3 shadow-[var(--shadow)]">
      <div className="rounded-md border border-[var(--invert-line)] bg-[var(--invert-bg)] p-4 text-[var(--invert-text)]">
      ...
      <div className="mt-3 grid gap-3 md:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-md border border-[var(--line)] bg-[var(--card-bg)] p-3">
        ...
        <div className="rounded-md border border-[var(--line)] bg-[var(--card-bg)] p-3">
          ...
          <div className="space-y-2 text-sm">
            <p className="rounded-md bg-[var(--panel-soft)] p-2 text-[var(--warning)]">Camera group latency spike</p>
            <p className="rounded-md bg-[var(--panel-soft)] p-2 text-[var(--brand)]">Docker agent heartbeat OK</p>
            <p className="rounded-md bg-[var(--panel-soft)] p-2 text-[var(--success)]">Telegram notification delivered</p>
          </div>
        </div>
      </div>
    </div>
